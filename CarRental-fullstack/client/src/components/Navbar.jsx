...
const Navbar = () => {
  ...
  return (
    ...
    className={`flex items-center justify-between px-6 md:px-10 lg:px-16 py-4 text-gray-600 border-b border-borderColor relative transition-all ${location.pathname === "/" && "bg-light"}`}>
        ...
        <Link to='/'>
           <motion.img
            ...
            src={assets.mylogo}
            alt="logo"
            className="h-12 scale-[1.8] object-contain"
            />
        </Link>
